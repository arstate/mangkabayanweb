    ...
    <div className="min-h-screen bg-[#F5F5F5] pt-32 pb-20 relative">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
           ...
           <GlassCard className="p-8 bg-mangka-primary text-white">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2"><CheckCircle size={18} className="text-mangka-secondary" /> Rasa Otentik</li>
                <li className="flex items-center gap-2"><CheckCircle size={18} className="text-mangka-secondary" /> Pelayanan "Someah"</li>
                <li className="flex items-center gap-2"><CheckCircle size={18} className="text-mangka-secondary" /> Bahan Baku Segar</li>
                <li className="flex items-center gap-2"><CheckCircle size={18} className="text-mangka-secondary" /> Kebersihan Terjamin</li>
              </ul>
           </GlassCard>
        </div>
