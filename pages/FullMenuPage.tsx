...
const allMenus: MenuItem[] = [
  ...
  { id: 8, category: 'ayam_daging', name: "Ayam Goreng Kremes", description: "Ayam goreng bumbu kuning dengan taburan kremes yang melimpah.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBN7_gRnV_ELdAgFbR59ZgrutcXkf808zchKbdR0Llk8EvcJ_wFgbvCUW5A4fxk9TcOrBs97x2uuvIIvRmAE6ZxWd7w5YB-1dfKBXw=w800" },
  { id: 9, category: 'ayam_daging', name: "Ayam Bakar", description: "Ayam bakar bumbu rujak dengan cita rasa manis pedas legit.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBMP3CpiwnnrXnjHGyhdjxXwbALpxqSF3xZub1rJKgO-MydFFwtNhBJaXyK_m4QFcErsfYpupxBmoSz4fGbBfXYLF7RGKN4ERRRkvw=w800", isRecommended: true },
  { id: 10, category: 'ayam_daging', name: "Gepuk Goreng", description: "Daging sapi gepuk empuk dengan rasa manis gurih khas Sunda.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBMaOsC9VvzWFCc1rvzRMawCypInGOeDhgRSC7vlVFEmlo68_Cm6ANyqJZGYp_PI1m93L1UhNo3MQon7VEltsaCoFo-iKtBNTfnNMg=w800" },
  { id: 11, category: 'ayam_daging', name: "Ayam Goreng Mentega", description: "Potongan ayam digoreng dan ditumis dengan saus mentega gurih.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBNbX9FBrXFxBFNaX20P36v0DVTehsByXhfeqGj0UWRs1Nw-vLjV2Pf9zEtvCKyJ77II9IbE8_Ux11fZlj7mOox6ciMm39gQb_7_Gg=w800" },
  { id: 12, category: 'ayam_daging', name: "Sapi Lada Hitam", description: "Daging sapi iris dimasak dengan saus lada hitam pedas hangat.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBO98pULJKTpFKjKloPA5oSAH_T73TmqZy9UYwMnvZy7Q4WVAe9bxLw1cwciHaYDiadfqyF5uon4PgdMJ-lbqBRCTYsJMlFk1BsiUg=w800" },
  { id: 13, category: 'ayam_daging', name: "Sapi Rica-Rica", description: "Olahan daging sapi dengan bumbu rica-rica pedas aromatik.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBPUMPlUxJ8TvZeZvSBBjX9wYsDcbzzVSueeYGopIeAQSbQlw_BNNtWhCtolgnesD1KngQRoRsBkPS_UvcVy4Efa12U0WYpTAMwuAA=w800" },
  { id: 32, category: 'ayam_daging', name: "Sop Buntut", description: "Sop buntut sapi yang empuk dengan kuah kaldu rempah yang kaya rasa.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBOGxR9CwsYbfmwItMMJ8rJBIRE19vQTZZjYDsELZUuhTH_96MZ-19lvvIsCDQQkugv4GvU8SathJsc7y0VLWNWnj2WXmK0JjzmrLA=w800" },

  // Kategori: Nasi & Mie
  { id: 14, category: 'nasi_mie', name: "Nasi Timbel Komplit", description: "Nasi pulen bungkus daun pisang, tahu, tempe, sambal, lalap + Lauk Pilihan (Ayam/Gepuk/Gurame).", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBOMztMxWg891dALLylvHZPWw_rgtug-Bs7GpwZdWcwCzp2NytYXrrklSCJG9QwIq8EZtTkaksgxdwMWSzD1mCfFDEzpz2LpHJpAxQ=w800", isRecommended: true },
  { id: 15, category: 'nasi_mie', name: "Nasi Bakar Komplit", description: "Nasi berbumbu rempah dibakar daun pisang + Lauk Pilihan (Ayam/Cumi Asin/Telor Asin).", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBOeatA8YKl_z5qcrJHD9GWxskScz0-uY0GGhwbT-nSNdQvoU1cfH8dVixqyiIJHhkZ_cw1UaHm9os727Y2wT7TKByNFNFjS_D9qog=w800" },
  { id: 16, category: 'nasi_mie', name: "Nasi Goreng Seafood", description: "Nasi goreng spesial dengan topping seafood (Udang, Cumi, Bakso Ikan) yang melimpah.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBP3RMQCIV-Hntz7XuD3ji40dQb44X2UiTljHIBamsZOPkqjtXWEf4Whx3VqjzdclRh_uKp7hO74uoSW-STZ61kcnN96f5pItPpiUA=w800" },
  { id: 17, category: 'nasi_mie', name: "Mie Goreng", description: "Mie goreng jawa dengan sayuran dan suwiran ayam.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBNz0fn8PacuCxOvDnTbUwX83kIhniRi2M75idWUzyTxD2ZvpuxgvQWx--j7KkCMIQJPuIQDZ33l1sUnXx5PjUqyzZ_bmA428IDGkw=w800" },
  ...
  { id: 20, category: 'sayuran', name: "Sayur Asem", description: "Kuah segar manis asam dengan jagung, labu siam, kacang panjang.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBMAGd-zOSdtsVKR_cLyAnnLK2_KLh9f5mWW_mHq1J4bJ6irdYICzP87VdcaZC8q6XqoRCqtr8uJLG6Yt2RSYYJdXPCpb2b6I547PQ=w800" },
  { id: 21, category: 'sayuran', name: "Karedok", description: "Salad sayur mentah khas Sunda dengan bumbu kacang kencur.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBO6F5JJ-e2jG6fjkn9OWBt5hYTu9UViayBr8Fc6uASD4VcqhKFWlFcjiBXhOULG6-Xi35ytcNwBByI3LN4trUlxu3-bt_IQki-CuA=w800" },
  { id: 22, category: 'sayuran', name: "Tumis Kangkung Balacan", description: "Kangkung tumis dengan terasi yang harum dan gurih.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBOoLuHPEVegoKy8EKff-MuT5AuOgdj_tR1gmz7374DPRhQ8GrBTN9032ekaGz_KiKgPkmKUbge-zGopDvl_kGgWwmC7SiNMyWvJVw=w800" },

  // Kategori: Pepes & Tahu/Tempe
  { id: 23, category: 'pepes', name: "Pepes Jamur", description: "Jamur tiram berbumbu pepes dikukus dalam daun pisang.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBPfdnVtazN920w8hnZXr3JyPIuNU_VWZuneTSjFp0XNyXn5ef5YF41I9O99g1q6arA_tjP2EtTCQ54_QpFXGAV2Oo4DXf9KfOeimw=w800" },
  { id: 24, category: 'pepes', name: "Pepes Tahu", description: "Tahu putih lembut berbumbu rempah kukus.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBOu36vuTYMfhH3yeHRO_4bt6_9YQbI1UxR05STwuPwINtbQWsWs1N382WfxLDrYjehSe59emHSbp3P3IHpxfo2-FhY8JRlGC528OQ=w800" },
  { id: 25, category: 'pepes', name: "Tempe Goreng Tepung", description: "Tempe goreng dengan balutan tepung renyah.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBMVetVdKhIhEHrP1c3z8gBfi944azmDgKaYgC2FHTFIe0NflB0LJqgckdddZC9XxCCgpwLf48bhoFixdjFC7GY7KHZ1QZ6EIOiDQQ=w800" },

  // Kategori: Sambal
  { id: 26, category: 'sambal', name: "Sambal Dadak Spc Mang Kabayan", description: "Sambal terasi segar yang diulek dadakan, pedas nendang.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBNopsO9tAq1AGAmSCdKU0Yb4bY0kqVhSbEoT7EXafGKwhBT3fe-RIGzkW6ZiXj8vqVHTj9gZTy91_fLI8yfCJCtVw0znF_JPgXr9Q=w800" },
  { id: 27, category: 'sambal', name: "Sambal Mangga", description: "Sambal dengan irisan mangga muda yang asam segar.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBPr-293CLvrNoNP1aJCYRiRs2dYK4J664bLCmvdv0ZYLEE8IFCRfFTucjyqra0CW13OQD3HsA-UipIgmgUrSGh4w680aEYHO2r_IA=w800" },
  ...
  { id: 31, category: 'minuman', name: "Kelapa Muda", description: "Air kelapa muda utuh, segar dan alami.", image: "https://lh3.googleusercontent.com/drive-storage/AJQWtBOJn-5C1JvUQVBACLgeN-EliSiRkBuSGQ2vmTpe7Mz8wjoZk4gOWdZiZ_JdCmKb6a0j0L5rYKxkZV7lOAn725-fLC3k2bnJBW3gfA=w800" }
];
